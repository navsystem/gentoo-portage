...
# $Header: /var/cvsroot/gentoo-x86/net-mail/offlineimap/offlineimap-6.5.5.ebuild,v 1.4 2014/01/14 15:10:17 ago Exp $
...
pkg_postinst() {
	...
	elog "display the server's cert fingerprint and require you to add# Copyright 1999-2014 Gentoo Foundation
# Distributed under the terms of the GNU General Public License v2
# $Header: /var/cvsroot/gentoo-x86/net-mail/offlineimap/offlineimap-6.5.5.ebuild,v 1.4 2014/01/14 15:10:17 ago Exp $
