...
MY_LIBDIR=/usr/lib
PATCHES=(
	"${FILESDIR}/040-0001-dracut-functions.sh-support-for-altern.patch"
	"${FILESDIR}/040-0002-gentoo.conf-let-udevdir-be-handled-by-.patch"
	"${FILESDIR}/040-0003-Use-the-same-paths-in-dracut.sh-as-tho.patch"
	"${FILESDIR}/040-0004-Install-dracut-install-into-libexec-di.patch"
	)
